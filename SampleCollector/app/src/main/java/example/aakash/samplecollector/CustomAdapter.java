...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            vi = inflater.inflate(R.layout.history, null);

            /****** View Holder Object to contain tabitem.xml file elements ******/

            holder = new ViewHolder();
            holder.text = (TextView) vi.findViewById(R.id.tvcode);
            holder.text1 = (TextView) vi.findViewById(R.id.tvresp);
        ...
        if (data.size() <= 0) {
            ...
            holder.text1.setText(tempValues.getLocation());
